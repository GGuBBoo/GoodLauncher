...
public class LauncherAction {
    ...
    public static ActionDisplayItem[] actionDisplayItems = new ActionDisplayItem[]{
            ...
            new ActionDisplayItem(Action.LockScreen, HomeActivity._launcher.getResources().getString(R.string.minibar_title__lock_screen), HomeActivity._launcher.getResources().getString(R.string.minibar_summary__lock_screen), R.drawable.ic_lock_black_36dp, 24),
            ...
            new ActionDisplayItem(Action.SearchBar, HomeActivity._launcher.getResources().getString(R.string.minibar_title__search_bar), HomeActivity._launcher.getResources().getString(R.string.minibar_summary__search_bar), R.drawable.ic_brush_black_24dp, 89),
