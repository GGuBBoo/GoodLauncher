...
public class SearchBarByStudy extends FrameLayout {
    ...
    public SearchBarByStudy(@NonNull Context context) {
        super(context);
        init();
    }

    public SearchBarByStudy(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SearchBarByStudy(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    private void updateSwitchIcon() {
        _switchButton.setImageResource(Setup.appSettings().getSearchUseGrid() ? R.drawable.ic_widgets_black_24dp : R.drawable.ic_storage_black_24dp);
    }
