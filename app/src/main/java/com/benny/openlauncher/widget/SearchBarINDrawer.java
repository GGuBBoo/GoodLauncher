...
public class SearchBarINDrawer extends FrameLayout {
    ...
    public SearchBarINDrawer(@NonNull Context context) {
        super(context);
        init();
    }

    public SearchBarINDrawer(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public SearchBarINDrawer(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
    ...
    private void init() {
        ...
        _searchCardContainer.setCardBackgroundColor(Color.BLACK);
        _searchCardContainer.setVisibility(View.INVISIBLE);
